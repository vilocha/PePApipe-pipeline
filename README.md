...
python -u ./PePApipe.py -s SAMPLE -o ./SAMPLE -t 12 -r1 ./SAMPLE/*R1*fastq.gz -r2 ./SAMPLE/*R2*fastq.gz -R1 ../reference_dAB/mutante_dAB.fasta -R2 ../reference_pig/Sus_scrofa11.1_genomic_complete.fasta &> pipeline_log.txt
